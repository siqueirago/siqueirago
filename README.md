...
## 👨‍🎓 Sobre Mim
Atualmente estou me graduando em Análise e Desenvolvimento de Sistemas, tenho, experiência em projetos focados no desenvolvimento de interfaces web utilizando HTML e CSS, com ênfase na criação de layouts responsivos, estilização avançada e otimização de páginas para uma experiência de usuário intuitiva e atraente.
